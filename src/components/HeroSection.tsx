...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content Grid */}
      <div className="relative z-10 container mx-auto px-4 grid lg:grid-cols-3 gap-12 items-center min-h-screen py-24">
        
        {/* Project Info Card - Left */}
        <div className="lg:col-span-1">
          <div className="card-overlay p-8 rounded-3xl shadow-3xl">
            {/* Limited Time Banner */}
            <div className="bg-gradient-to-r from-primary to-primary-light text-white px-4 py-2 rounded-lg text-center mb-4 font-semibold shadow-lg">
              <div className="flex items-center justify-center space-x-2">
                <span className="text-sm">⏰</span>
                <span className="text-sm">Available For A Limited Time Only!</span>
              </div>
            </div>

            {/* Project Title */}
            <div className="text-center mb-4">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">L&T Green Reserve</h1>
              <p className="text-base text-gray-600 mb-1 font-medium">At Noida Expressway, Sector-128</p>
              <p className="text-sm text-gray-500 font-semibold">By L&T Realty</p>
            </div>

            {/* Project Stats */}
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <div className="font-semibold text-gray-700 mb-1 text-sm">Land Parcel</div>
                <div className="text-2xl font-bold text-primary">6 Acres</div>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <div className="font-semibold text-gray-700 mb-1 text-sm">Floors</div>
                <div className="text-2xl font-bold text-primary">45+</div>
              </div>
            </div>

            <div className="text-center mb-4 p-3 bg-gray-50 rounded-lg">
              <div className="font-semibold text-gray-700 mb-1 text-sm">Premium Units</div>
              <div className="text-2xl font-bold text-primary">600+</div>
            </div>

            {/* Special Offers */}
            <div className="bg-gradient-to-r from-gold to-primary text-white p-4 rounded-lg mb-4 text-center shadow-lg">
              <div className="font-bold text-base mb-1">🎯 Avail Early Bird Offers</div>
              <div className="text-xs font-medium">Designed by Hafeez Contractor</div>
            </div>

            {/* Pricing */}
            <div className="mb-4 p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg flex flex-col items-center text-center min-h-[150px] md:min-h-[180px]">
              <span className="font-semibold text-gray-700 text-xs md:text-base">Luxury 3, 4 & 5 BHK Starting</span>
              <div className="flex-1 flex items-center">
                <span className="text-4xl md:text-6xl font-black text-primary tracking-tight">₹ 6.50 Cr*</span>
              </div>
              <span className="text-gray-600 font-medium text-xs md:text-sm">Onwards</span>
            </div>
